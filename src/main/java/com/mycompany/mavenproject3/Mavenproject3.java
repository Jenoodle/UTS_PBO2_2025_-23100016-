...
public class Mavenproject3 extends JFrame implements Runnable {
    ...
    public Mavenproject3() {
        ...
        productList.add(new Product(1, "P001", "Americano", "Coffee", 15000, 25));
        productList.add(new Product(2, "P002", "Pandan Latte", "Coffee", 30000, 10));
        productList.add(new Product(3, "P003", "Aren Latte", "Coffee", 25000, 20));
        productList.add(new Product(4, "P004", "Matcha Frappucino", "Tea", 35000, 25));
        productList.add(new Product(5, "P005", "Jus Apel", "Juice", 18000, 8));
